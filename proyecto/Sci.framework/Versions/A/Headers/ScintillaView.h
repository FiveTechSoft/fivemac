...
- (long) setGeneralProperty: (int) property parameter: (long) parameter value: (long) value;
- (long) setGeneralProperty: (int) property value: (long) value;

- (long) getGeneralProperty: (int) property;
- (long) getGeneralProperty: (int) property parameter: (long) parameter;
- (long) getGeneralProperty: (int) property parameter: (long) parameter extra: (long) extra;
- (long) getGeneralProperty: (int) property ref: (const void*) ref;
- (long) setColorProperty: (int) property parameter: (long) parameter value: (NSColor*) value;
- (long) setColorProperty: (int) property parameter: (long) parameter fromHTML: (NSString*) fromHTML;
- (NSColor*) getColorProperty: (int) property parameter: (long) parameter;
- (long) setReferenceProperty: (int) property parameter: (long) parameter value: (const void*) value;
- (const void*) getReferenceProperty: (int) property parameter: (long) parameter;
- (long) setStringProperty: (int) property parameter: (long) parameter value: (NSString*) value;
- (long) getCharProperty: (int) property parameter: (long) parameter value: (char*) value;
- (NSString*) getStringProperty: (int) property parameter: (long) parameter;
- (long) setLexerProperty: (NSString*) name value: (NSString*) value;
...
@property (retain) NSView <InfoBarCommunicator>* infoBar;
@end
